...
def mixed_effects_model(df: pd.DataFrame, formula: str, groups: str, vc_formula: dict = None):
    """
...
def hierarchical_permutation_test(data, condition_col="condition", group_col="dyad", n_perms=1000):
    """
