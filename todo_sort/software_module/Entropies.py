...
def vecEntropy(
    Gt: npt.NDArray[nx.classes.graph.Graph] | List[nx.classes.graph.Graph], estim: Callable = getEntropyKozachenko
) -> npt.NDArray[float]:
