...
``get_plv_matrix`` in :mod:`hyphi.simulation.kuramoto_simulations` exists only for the
JAX-accelerated Kuramoto simulation path; everything else should use this module.
