...
``gen_tv_weighted_sw`` produce time-varying (unweighted and weighted) series;
``gen_nature_sw`` and ``gen_neureps_wsw`` are the fixed presets used in the accompanying work.
"""
